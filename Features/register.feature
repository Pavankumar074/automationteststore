...
Background:
    ...
    And User registers as new customer by entering personal details "frst_name10" "last_name10" "first_name10@test.in"
    And enters address details "church street" "United Kingdom" " Aberdeen" "Bangalore" "560000"
    And enters Login detais "automation_test10" "test@123" "test@123"
    ...
    Scenario: Place an order as returning customer
   	When User logs in as returned customer by entering username "automation_test10" and password "test@123"
